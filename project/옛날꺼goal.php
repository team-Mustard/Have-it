...
<div class="main col-md-8 col-md-offset-2">    
    ...
    <?php
        ...
        $term_e = $row['endTerm'];
            ...
            //목표 수정 폼
            echo '<form name="goal_modify_form" method="post" action="db/goalmodify.php">';
...
?> 
        ...
        <?php
            $r_last = "SELECT * FROM routine ORDER BY routineID DESC LIMIT 1";
            $r_result = mysqli_query($conn, $r_last);
            $r_row = mysqli_fetch_array($r_result);
            $last_ID = $r_row['routineID'];
            $last_ID += 1;
        ?>
  ...
  <?php 
    ...
    <script>
        ...
        function goal_modify(){
            ...
            var save = document.getElementById("rousave");
            save.style = "display:visible; margin-top: 20px; float:right;";
            
            var plus_btn = document.getElementById("plus_btn");
            plus_btn.style = "display:visible;";
        }
