...
<div class="container-fluid" id="top">
        <div class="sign text-center">
          ...
          <div class="line"></div>
          <div class="buttons">
            <a class="btn purple first" href="javascript:location.href='./login.php'">
                <span style="font-size:1.3em;">로그인</span><br/>
                <span>Login</span>
            </a>
            <br>
            <a class="btn pink second" href="javascript:location.href='./signup.php'">
        ...
        <div class="problem row text-center">
          ...
          <div class="col-md-6">
              <div class="col-md-4">
                  <img class="problemIcon img-circle" src="./img/thumb_down.svg" alt="thumb-down" width="85px" height="85px">
                  <p class="problemSub">날 지치게 하는</p>
                  <p class="problemTitle"><b>저조한 능률</b></p>
              </div>
              <div class="col-md-4">
                  <img class="problemIcon img-circle" src="./img/timer_off.svg" alt="thumb-down" width="85px" height="85px">
                  <p class="problemSub">어떤 다짐도</p>
                  <p class="problemTitle"><b>작심 삼일</b></p>
              </div>
              <div class="col-md-4">
                  <img class="problemIcon img-circle" src="./img/date_range.svg" alt="thumb-down" width="85px" height="85px">
        ...
        <div class="solution text-center">
          <h4>거듭되는 실패 속</h4>
          <h4>성공을 이끄는</h4>
          <h4>나만의 <strong>보물</strong>같은 습관 형성 일기!</h4>
          <img class="diamond" alt="돌아가는 다이아몬드" src="./img/diamond.gif" width="120px">
