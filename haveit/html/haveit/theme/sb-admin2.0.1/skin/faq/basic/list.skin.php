...
<!-- FAQ 시작 { -->
        ...
        <div class="container-fluid">
			...
			<fieldset id="faq_sch">
				...
				<button type="submit" value="검색" class="btn_submit"><i class="fas fa-search"></i> 검색</button>
				</form>
			</fieldset>
					...
					<ol>
						...
						<li>
							<h3>
								...
								<button class="tit_btn" onclick="return faq_open(this);"><i class="far fa-plus-square"></i><span class="sound_only">열기</span></button>
							</h3>
							<div class="con_inner">
								<?php echo conv_content($v['fa_content'], 1); ?>
								<button type="button" class="closer_btn"><i class="far fa-minus-square"></i><span class="sound_only">닫기</span></button>
							</div>
						</li>
						<?php
						}
...
<?php
if ($admin_href)
    echo '<div class="faq_admin"><a href="'.$admin_href.'" class="btn_admin btn" title="FAQ 수정"><i class="fas fa-cogs"></i><span class="sound_only">FAQ 수정</span></a></div>';
?>
