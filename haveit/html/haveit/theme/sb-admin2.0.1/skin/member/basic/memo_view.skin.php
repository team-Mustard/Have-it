						...
						<div id="memo_view_ul">
							<div class="memo_view_li memo_view_name">
								<ul class="memo_from">
									...
									<li class="memo_view_date"><span class="sound_only"><?php echo $kind_date ?>시간</span><i class="fas fa-user-clock"></i> <?php echo $memo['me_send_datetime']; ?></li> 
									<li class="memo_op_btn list_btn"><a href="<?php echo $list_link; ?>" class="btn_b01 btn"><i class="fas fa-list"></i><span class="sound_only">목록</span></a></li>
									<li class="memo_op_btn del_btn"><a href="<?php echo $list[$i]['del_href']; ?>" onclick="del(this.href); return false;" class="memo_del btn_b01 btn"><i class="fas fa-trash-alt"></i> <span class="sound_only">삭제</span></a></li>	
								</ul>
								<div class="memo_btn">
									<?php if($prev_link) {  ?>
