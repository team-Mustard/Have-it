...
?>
        ...
        <div class="container-fluid">
			...
			<div class="card shadow mb-4" id="bo_gall">
				...
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					...
					<div class="dropdown no-arrow">					
						...
						<button type="button" class="btn_bo_sch btn_b01 btn" title="게시판 검색"><i class="fas fa-search"></i><span class="sound_only">게시판 검색</span></button>
				...
				<div class="bo_fx">
					...
					<ul class="btn_bo_user">
						<?php if ($admin_href) { ?><li><a href="<?php echo $admin_href ?>" class="btn_admin btn" title="관리자"><i class="fas fa-cogs"></i></a></li><?php } ?>
						<?php if ($rss_href) { ?><li><a href="<?php echo $rss_href ?>" class="btn_b01 btn" title="RSS"><i class="fas fa-rss-square"></i></a></li><?php } ?>
						<?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b01 btn" title="글쓰기"><i class="fas fa-edit"></i></a></li><?php } ?>
					</ul>	
					<?php } ?>
				</div>
				<?php } ?> 
