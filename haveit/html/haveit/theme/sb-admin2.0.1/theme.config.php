...
$memo_count = sql_fetch(" SELECT COUNT(*) AS _cnt FROM g5_memo WHERE me_recv_mb_id = '{$member['mb_id']}' AND me_type = 'recv' AND me_read_datetime = '0000-00-00 00:00:00' ");

$memo_list_result = sql_query(" SELECT * FROM g5_memo WHERE me_recv_mb_id = '{$member['mb_id']}' AND me_type = 'recv' AND me_read_datetime = '0000-00-00 00:00:00' ");
?>